...
import xyz.tolvanen.weargram.ui.home.HomeViewModel
...
@Composable
fun ShortDescription(message: TdApi.Message, chat: TdApi.Chat, viewModel: ViewModel, client: TelegramClient, modifier: Modifier = Modifier) {
